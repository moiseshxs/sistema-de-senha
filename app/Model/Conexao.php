...
=======
            $pdo->query("CREATE TABLE tbsenha(idSala INT PRIMARY KEY AUTO_INCREMENT, senha VARCHAR(5), statusSenha BOOLEAN, updateAt DATETIME, idGuiche INT, FOREIGN KEY(idGuiche) REFERENCES tbguiche(idGuiche))");
>>>>>>> Stashed changes
=======
            $pdo->query("CREATE TABLE tbsenha(idSala INT PRIMARY KEY AUTO_INCREMENT, senha VARCHAR(5), statusSenha BOOLEAN, updateAt DATETIME, idGuiche INT, FOREIGN KEY(idGuiche) REFERENCES tbguiche(idGuiche))");
>>>>>>> Stashed changes
