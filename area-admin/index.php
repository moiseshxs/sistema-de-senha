...
<body>
  <div class="container-fluid vw-100 vh-100">
    <div class="content h-100 w-100">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
            ...
            <g id="Camada_x0020_1">
              ...
              <path id="7" class="fil0"
                d="M220.19 154.57l-5.54 0 0 -11.75c0,-3.59 -1.3,-5.39 -3.89,-5.39 -1.31,0 -2.37,0.49 -3.19,1.47 -0.82,0.97 -1.23,2.21 -1.23,3.72l0 11.95 -5.56 0 0 -20.97 5.56 0 0 3.37 0.07 0c1.54,-2.58 3.8,-3.87 6.8,-3.87 4.66,0 6.98,2.88 6.98,8.64l0 12.83z" />
              <path id="8" class="fil0"
                d="M226.14 134.93c0.95,-0.54 2.17,-0.98 3.67,-1.32 1.51,-0.34 2.86,-0.51 4.06,-0.51 5.66,0 8.5,2.88 8.5,8.62l0 12.85 -5.31 0 0 -3.09 -0.1 0c-1.41,2.41 -3.51,3.61 -6.29,3.61 -2.02,0 -3.62,-0.56 -4.81,-1.7 -1.18,-1.14 -1.78,-2.66 -1.78,-4.59 0,-4 2.39,-6.32 7.15,-6.96l5.85 -0.8c0,-2.67 -1.31,-4.01 -3.91,-4.01 -2.49,0 -4.83,0.78 -7.03,2.34l0 -4.44zm6.77 10.07c-2.4,0.3 -3.59,1.37 -3.59,3.2 0,0.84 0.28,1.5 0.85,2.02 0.58,0.52 1.35,0.78 2.32,0.78 1.33,0 2.43,-0.47 3.29,-1.41 0.87,-0.94 1.3,-2.11 1.3,-3.54l0 -1.59 -4.17 0.54z" />
              <polygon id="9" class="fil0"
                points="263.84,154.57 245.5,154.57 245.5,152.38 256.56,137.83 246.56,137.83 246.56,133.6 263.81,133.6 263.81,136.17 253.13,150.34 263.84,150.34 " />
              <path id="10" class="fil0"
                d="M285.85 145.65l-14 0c0.22,3.57 2.24,5.35 6.06,5.35 2.33,0 4.41,-0.61 6.23,-1.83l0 4.23c-1.94,1.13 -4.44,1.69 -7.48,1.69 -3.27,0 -5.8,-0.94 -7.62,-2.83 -1.81,-1.89 -2.73,-4.53 -2.73,-7.93 0,-3.32 0.98,-6.02 2.93,-8.11 1.95,-2.08 4.39,-3.12 7.31,-3.12 2.93,0 5.22,0.89 6.85,2.69 1.64,1.8 2.45,4.27 2.45,7.41l0 2.45zm-5.24 -3.65c0,-3.33 -1.37,-4.99 -4.12,-4.99 -1.14,0 -2.14,0.45 -3.01,1.36 -0.88,0.9 -1.42,2.12 -1.63,3.63l8.76 0z" />
              <path id="11" class="fil0"
              ...
              <polygon class="fil1"
                points="75.66,110.59 75.66,89.78 23.48,89.78 23.48,64.96 69.86,64.96 69.86,44.44 23.48,44.44 23.48,20.66 75.36,20.66 75.36,0 0,0 0,110.59 " />
              <path id="1" class="fil1"
                d="M139.42 110.59l0 -17.84 -9.81 0c-3.86,0 -6.71,-0.82 -8.54,-2.45 -1.84,-1.64 -2.75,-4.34 -2.75,-8.1l0 -32.55 20.81 0 0 -17.69 -20.81 0 0 -21.11 -21.71 0 0 21.11 -11.29 0 0 17.69 11.29 0 0 33.74c0,8.91 2.76,15.68 8.25,20.29 5.5,4.6 13.06,6.91 22.67,6.91l11.89 0z" />
      ...
      <div class="row meiomeio d-flex justify-content-center align-items-center">
        <div class="col"></div>
        <div class="col d-flex justify-content-center align-items-center">
          <button class="btn btn-success me-3">Sim Compareceu</button>
          <button class="btn btn-danger ms-3">Não Compareceu</button>
        </div>
        <div class="col d-flex justify-content-end align-items-center"><button id="abrirModal" type="button"
