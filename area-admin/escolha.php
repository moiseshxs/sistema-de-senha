  ...
  <div class="container-fluid vw-100 vh-100">
    ...
    <div class="row w-100 meio">
      ...
      <div class="col-3  d-flex justify-content-center align-items-center">
            <div class="escolher w-100 bg-success d-flex justify-content-center align-items-center"><p class="fs-1 fw-bold text-light">TRIAGEM</p></div>
      </div>
      <div class="col"></div>
      <div class="col-3  d-flex justify-content-center align-items-center">
            <div class="escolher w-100 bg-success d-flex justify-content-center align-items-center"><p class="fs-1 fw-bold text-light">MATRICULA</p></div>
      </div>
      <div class="col"></div>
      <div class="col-3  d-flex justify-content-center align-items-center">
            <div class="escolher w-100 bg-success d-flex justify-content-center align-items-center"><p class="fs-1 fw-bold text-light">APM</p></div>
      </div>
      <div class="col"></div>
    </div>
