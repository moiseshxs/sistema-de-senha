        ...
        <div class="row vh-100 vw-100 m-0">
            <div  class="row h-75">
                <div id="lasts" class="col-4 border d-flex align-items-center justify-content-center flex-column"
                    ...
                    <div
                        class="row py-2 w-75 d-flex align-items-center justify-content-center border-bottom border-light border-4">
                        <p class="fs-2 fw-bold text-center text-uppercase text-light lh-1">Chamadas recentes</p>
                    </div>
                    <div
                        class="row py-2 w-75  border-bottom border-light border-4">
                        <div class="col d-flex justify-content-center align-items-center">
                            <p class="fs-1 fw-bold text-center text-uppercase text-light lh-1">AP07</p>
                        </div>
                        <div class="col">
                            <div class="row">
                                <div class="col d-flex align-items-center">
                                    <p class="fw-bold text-center text-uppercase text-light lh-1" style="font-size: 20px;">Sala - 5</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col d-flex align-items-center">
                                    <p class="fw-bold text-center text-uppercase text-light lh-1" style="font-size: 20px;">Guichê - 5</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-8 d-flex align-items-center justify-content-center flex-column">
                    <div class="row">
                        <div class="col d-flex align-items-center justify-content-center">
                            <p class="fw-bold text-center text-uppercase text-dark" style="font-size: 50px;">senha</p>
                        </div>
                    </div>
                    ...
                    <div class="row d-flex align-items-center justify-content-center">
                        <div class="row">
                            <div class="col d-flex align-items-center justify-content-center">
                                <p id="senhaAtual" class="fw-bold text-center text-uppercase text-dark" style="font-size: 150px;"><span
                                        style="color: #106018;">AP</span>06</p>
                            </div>
                        </div>
            ...
            <div class="row h-25">
                <div class="col-12 d-flex align-items-center justify-content-center"
                    style="height: 60%; background-color: rgba(0, 0, 0, 0.404);">
                ...
                <div class="col d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-10">
                        <div id="ww_f5c4ab7d7d6c6" v='1.3' loc='auto'
                            ...
                            Mais previsões: <a href="https://oneweather.org/pt/lisbon/25_days/" id="ww_f5c4ab7d7d6c6_u"
                                target="_blank">Meteorologia Lisboa 25 dias</a></div>
                    </div>
