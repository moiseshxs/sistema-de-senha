...
<body>
    <section class="container-fluid p-0">
        <div class="row vh-100 vw-100 m-0">
            ...
            <div id="lasts" class="col-4 border d-flex align-items-center justify-content-center flex-column pt-5" style="background-color: #2B8C44;">
                <div class="row w-75 d-flex align-items-center overflow-auto justify-content-center border-bottom border-light border-4">
                ...
                <div class="row" style="height: 80%;">
                    <div class="row">
                        ...
                        <div class="col d-flex align-items-center justify-content-center">
                            <p class="fw-bold text-center text-uppercase text-dark lh-1" style="font-size: 70px;">senha
                            </p>
                        </div>
                        <div class="col-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="row d-flex align-items-center justify-content-center">
                        <div class="row">
                            <div class="col d-flex align-items-center justify-content-center">
                                <p id="senhaAtual" class="fw-bold text-center text-uppercase text-dark lh-1" style="font-size: 200px;"><span style="color: #106018;">00</span>000</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col d-flex align-items-center justify-content-center flex-column">
                                <p class="fw-bold text-center text-uppercase lh-1" style="font-size: 40px;">Guichê</p>
                                <p id="guicheAtual" class="fw-bold text-center text-uppercase lh-1" style="font-size: 80px; color: #106018;">0</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row w-100 px-2" style="height: 20%; background-color: #c5c5c562;">
                    ...
                    <div class="col d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-3 d-flex align-items-center justify-content-center">
                            <div id="ww_73191feb4cc90" v='1.3' loc='id' a='{"t":"responsive","lang":"pt","sl_lpl":1,"ids":["wl1583"],"font":"Arial","sl_ics":"one_a","sl_sot":"celsius","cl_bkg":"#FFFFFF00","cl_font":"#000000","cl_cloud":"#d4d4d4","cl_persp":"#2196F3","cl_sun":"#FFC107","cl_moon":"#FFC107","cl_thund":"#FF5722","sl_tof":"3","el_wfc":3,"cl_odd":"#00000000","el_nme":3}'>
                                Mais previsões: <a href="https://oneweather.org/sao_paulo/30_days/" id="ww_73191feb4cc90_u" target="_blank">Weather forecast Sao Paulo 30 days</a></div>
